...
#define run_line template <> \
struct __run_line<decltype([]() {})>
#define RE decltype([]() {})
...
namespace inheritance_order_tests
{
    ...
    run_line : if_<True, Assignment<b>, short, RE>,
    ...
    run_line : Delayed<Assignment<b>>::call<short, RE>,
    ...
    run_line : Delayed<Assignment<g>>::template call<float, RE>,
    ...
    template <class T>
    struct misdirection : Assign<j, value<i, RE>, RE>
    {
    };
...
namespace memberfunction_order_test
{
    ...
    run_line
    {
        auto _1()
        {
            return Delayed<Assignment<b>>::template call<float, decltype([]() {})>();
        };
...
namespace recursion_test_1
{
    ...
    template <class _>
    struct SumOfFirstNIntegers : Assign<a,
...
namespace random_fun_tests
{
    ...
    template <class T>
    struct Func : Extractable<RE>, Assign<a, value<b, RE>, RE>
    {
    };
